...
export default function EditVoucher() {
    ...
    useEffect(() => {
        // Load voucher data
        axios.get(`http://localhost:5000/api/voucher/${ma_voucher}`)
            .then(res => {
                const data = res.data;
                setFormData({
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:5000/api/voucher/${ma_voucher}`, formData);
    ...
    return (
        <div className="container-fluid">
            <div className="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 className="h3 mb-0 text-gray-800">Sửa Voucher</h1>
                ...
                <div className="card-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="btn btn-primary">
                            <i className="fas fa-save"></i> Cập nhật Voucher
                        </button>
                    </form>
                </div>
            </div>
